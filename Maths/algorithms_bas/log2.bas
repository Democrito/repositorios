...
Input "log2 of: ", wx                                                           ' Enter with wx, to find log base 2. The value we want to calculate is stored in wx (1..65535)
...
Print wj + wz/32768                                                             ' wz to be fractional part (mantissa, as "wz/32768" implied, Qn.16 fixed point);
                                                                                ' Find (log base 2 of wx) => wj + (wz/32768), Q16.16 fixed point.
Sleep                                                                           ' The result has a resolution of 3 or 4 exact decimal places. Up to log2(9999) there will be 4 exact decimal places.
End                                                                             ' From log2(10000) it will give 4 exact decimal places and other times 3, with an error of -1 for the 4th decimal place.
