{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "8bd4f8c8-615b-456c-8e1b-5e7011775129",
          "type": "basic.output",
          "data": {
            "name": "error",
            "virtual": true
        ...
        {
          "id": "b98ee65a-8f89-4105-b73a-f89468bb9403",
        ...
        {
          "id": "688c6ec0-6853-47af-9ac3-2f00b6b7fb8e",
          "type": "basic.input",
          "data": {
            "name": "",
            "clock": true,
        ...
        {
          "id": "9a3dd0be-24c7-4ea4-a8b3-75352cb19982",
        ...
        {
          "id": "56e920e9-8510-4ed0-8e3a-88815cd1d7e7",
          "type": "basic.output",
          "data": {
            "name": "log10",
            "range": "[31:0]",
        ...
        {
          "id": "9bec8dbb-7d90-4f6e-9208-7a1fee20df0e",
          "type": "basic.input",
          "data": {
            "name": "",
            "range": "[15:0]",
        ...
        {
          "id": "b46c864f-81ca-4307-a562-e7341b3b6ace",
          "type": "basic.inputLabel",
          "data": {
            "blockColor": "fuchsia",
            "name": "dn",
        ...
        {
          "id": "352934d1-468d-40b7-9d70-6c7ca6f9e4eb",
          "type": "basic.output",
          "data": {
            "name": "done",
            "virtual": true
        ...
        {
          "id": "87f15a8a-a9b1-4032-b817-7fa1ae4221ed",
          "type": "basic.outputLabel",
          "data": {
            "blockColor": "fuchsia",
            "name": "dn",
        ...
        {
          "id": "d5e0946a-6861-4a23-bbed-a5e2df497dbd",
          "type": "basic.input",
          "data": {
            "name": "start",
            "clock": false,
        ...
        {
          "id": "65dfc3a9-254b-4ec6-af48-6b958ad2c9b3",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "7b1c7e69-18c9-48ff-80be-984eb0fb2ba7",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "aa604e2f-1a71-4ae8-b213-d1d3751256b9",
          "type": "basic.code",
          "data": {
        ...
        {
          "id": "12117f45-b952-4b95-99da-fc6ac34bb2e5",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "ba1daebb-2d3e-4d3d-a3b2-43b2555fb521",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "c0902095-ef0d-4a39-9ddc-0e860d60229a",
      ...
      "wires": [
        {
          "source": {
            "block": "b98ee65a-8f89-4105-b73a-f89468bb9403",
            "port": "outlabel"
          },
          "target": {
            "block": "8bd4f8c8-615b-456c-8e1b-5e7011775129",
            "port": "in"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "87f15a8a-a9b1-4032-b817-7fa1ae4221ed",
            "port": "outlabel"
          },
          "target": {
            "block": "352934d1-468d-40b7-9d70-6c7ca6f9e4eb",
            "port": "in"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "c0902095-ef0d-4a39-9ddc-0e860d60229a",
            "port": "802aec75-ea08-4c20-aee6-c1f0901569b9"
          },
          "target": {
            "block": "9a3dd0be-24c7-4ea4-a8b3-75352cb19982",
            "port": "inlabel"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "b46c864f-81ca-4307-a562-e7341b3b6ace",
            "port": "inlabel"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "9bec8dbb-7d90-4f6e-9208-7a1fee20df0e",
            "port": "out"
          },
          "target": {
            "block": "c0902095-ef0d-4a39-9ddc-0e860d60229a",
        ...
        {
          "source": {
            "block": "d5e0946a-6861-4a23-bbed-a5e2df497dbd",
            "port": "out"
          },
          "target": {
            "block": "c0902095-ef0d-4a39-9ddc-0e860d60229a",
        ...
        {
          "source": {
            "block": "688c6ec0-6853-47af-9ac3-2f00b6b7fb8e",
            "port": "out"
          },
          "target": {
            "block": "c0902095-ef0d-4a39-9ddc-0e860d60229a",
        ...
        {
          "source": {
            "block": "aa604e2f-1a71-4ae8-b213-d1d3751256b9",
            "port": "o"
          },
          "target": {
            "block": "56e920e9-8510-4ed0-8e3a-88815cd1d7e7",
            "port": "in"
          },
          "vertices": [],
          "size": 32
