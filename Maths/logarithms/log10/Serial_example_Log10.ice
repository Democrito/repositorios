{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "3ccdb08b-c6a5-4d02-b1ed-cbf59159c5d0",
        ...
        {
          "id": "bf6c7e0b-209f-4b1d-abf8-bb422d28034c",
        ...
        {
          "id": "eae52ab7-b92d-46bf-b0a0-a70f75956b57",
          "type": "2f27d31087efc4bba2940af473f66a09cc2e82af",
          "position": {
            "x": 344,
            "y": 128
          },
      ...
      "wires": [
        {
          "source": {
            "block": "3ccdb08b-c6a5-4d02-b1ed-cbf59159c5d0",
        ...
        },
        {
          ...
          "target": {
            "block": "bf6c7e0b-209f-4b1d-abf8-bb422d28034c",
            "port": "3a78dc2f-c9ad-4114-a98f-e2eede036b9d"
          }
        },
        {
          "source": {
            "block": "eae52ab7-b92d-46bf-b0a0-a70f75956b57",
  ...
  "dependencies": {
    ...
    "2f27d31087efc4bba2940af473f66a09cc2e82af": {
      "package": {
        "name": "log10_Q16_16",
        "version": "0.1",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "bf0c1dac-788e-45c6-9ac8-942581e0b432",
              "type": "61c09f333084ec24e6ed134845c7b5cc4687dc8f",
              "position": {
                "x": 400,
                "y": 232
              },
            ...
            {
              "id": "c17e39ac-752c-4dc7-b835-cb5e3b0fee3a",
              "type": "basic.code",
              "data": {
                "code": "assign y[15:0]  = man[31:16];\nassign y[31:16] = int;\n",
                "params": [],
                "ports": {
                  "in": [
                    {
            ...
            {
              "id": "3d7779f8-6cf4-475b-bcf4-38867b72eace",
              "type": "basic.code",
              "data": {
                "code": "// y = (lg2 * 19728) + 320000;\nassign y = (lg2*16)+(lg2*256)+(lg2*1024)+(lg2*2048)+(lg2*16384)+320000;",
                "params": [],
                "ports": {
                  "in": [
                    {
            ...
            {
              "id": "e3518702-ad6e-4202-a401-6bf929a0eed9",
              "type": "basic.info",
              "data": {
                "info": "Calculates the integer part of the base 10 logarithm with a special type of encoder.",
                "readonly": true
              },
              "position": {
                "x": 320,
            ...
            {
              "id": "714053f9-2e98-46e7-b49c-f77af889da80",
              "type": "basic.info",
              "data": {
                "info": "To calculate the mantissa of log10, we just need to multiply log2 by a constant.",
                "readonly": true
              },
              "position": {
                "x": 344,
            ...
            {
              "id": "1d8745cf-9d67-409c-95b8-4e8d16e8b58b",
              "type": "basic.info",
              "data": {
            ...
            },
            {
              ...
              "type": "basic.info",
              "data": {
                "info": "The formula is y = (log2 * 19728) + 320000\n\n* \"y\" is the result of the mantissa.\n* \"log2\" is the logarithm in base 2 that we are going to transform into base 10.\n* \"19728\" is the constant to multiply.\n* \"320000\" to adjust the result for decimal losses.\n\nThe constant comes from here:\nlog10(2) = 0.30102999566\n0.30102999566 x 65536 = **19728**.3017958\nand we take only the integer part.",
                "readonly": true
              },
              "position": {
                "x": 280,
            ...
            },
            {
              ...
              "type": "basic.info",
              "data": {
                "info": "\nI use a trick to make the multiplication more efficient, that's why you see the base 2 multiplications and the sum of all of them.\n\nThe number 320000 seems very large, however within a 32-bit variable it is not much and allows us to make very fine adjustments so that the result is as precise as possible. In the end, only the highest 16 bits will be needed to become the mantissa.",
                "readonly": true
              },
              "position": {
                "x": 720,
            ...
            {
              "id": "4e436cc9-edbc-4467-aaa4-4c9e9226b8a8",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "4e436cc9-edbc-4467-aaa4-4c9e9226b8a8",
            ...
            {
              "source": {
                "block": "bf0c1dac-788e-45c6-9ac8-942581e0b432",
                "port": "a768937c-c5c4-478a-ac22-fd13be9d0e23"
              },
              "target": {
                "block": "c17e39ac-752c-4dc7-b835-cb5e3b0fee3a",
                "port": "int"
              },
              "vertices": [],
              "size": 3
            ...
            {
              "source": {
                "block": "3d7779f8-6cf4-475b-bcf4-38867b72eace",
                "port": "y"
              },
              "target": {
                "block": "c17e39ac-752c-4dc7-b835-cb5e3b0fee3a",
    ...
    "61c09f333084ec24e6ed134845c7b5cc4687dc8f": {
      "package": {
        "name": "kartalosazk",
        "version": "0.1",
        "description": "log10 with priority.",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "a768937c-c5c4-478a-ac22-fd13be9d0e23",
              "type": "basic.output",
              "data": {
                "name": "y",
                "range": "[2:0]",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "a768937c-c5c4-478a-ac22-fd13be9d0e23",
                "port": "in"
              },
              "size": 3
            }
