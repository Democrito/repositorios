...
Este transceptor tiene capacidad para enviar y recibir 32 bytes y los vamos a aprovechar todos, los bytes que no necesites simplemente no se usarán, quedando como salidas al aire.  
...
Si te fuese posible, no uses reguladores de tensión conmutados (DC-DC, tipo step-down o step-up) porque generan mucho ruido a la salida.  
