  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "3d12f72b-a767-474d-8eb5-53554fba16a5",
          "type": "basic.info",
          "data": {
            "info": "Este ejemplo está diseñado para un motor de pasos bipolar, en concreto un Nema 17. Para poder usar otro tipo de motor has de cambiar las secuencias de una tabla que se encuentra en un módulo interno.",
            "readonly": true
          },
          "position": {
            "x": 672,
        ...
        {
          "id": "73c11263-5125-4493-a5f7-eaddd5bcfff9",
          "type": "basic.info",
          "data": {
